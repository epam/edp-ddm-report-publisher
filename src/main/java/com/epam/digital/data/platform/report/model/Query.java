...
public class Query {
    ...
    public boolean equals(Object o) {
        ...
        return dataSourceId == query1.dataSourceId && Objects.equals(name, query1.name)
            && Objects.equals(query, query1.query) && Objects
            .equals(description, query1.description);
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, query, description, dataSourceId);
    }
}
